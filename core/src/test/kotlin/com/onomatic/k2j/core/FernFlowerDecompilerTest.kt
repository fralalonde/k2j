...
class FernFlowerDecompilerTest {
    ...
    private fun java25Home(): Path? =
        Path.of("C:/Users/FrancisLalonde/AppData/Local/Programs/IntelliJ IDEA Ultimate/jbr")
            .takeIf { Files.isRegularFile(it.resolve("bin/java.exe")) }

    private fun decompilerJar(): Path? =
        Path.of(
    ...
    fun `decompiles accept plain Single with bridges removed`() {
        ...
        // The interface's own generic method legitimately erases to Object get() — that is not a bridge.
        ...
        assertTrue(bridgeBox!!.contains("Object get()"), "BridgeBox's own member erases to Object: $bridgeBox")
    }
