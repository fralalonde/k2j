        ...
        val projectDir = TestKitSupport.tempProject(
            ...
            kotlinSubject(
                ...
                tasks.register("printK2jConfig") {
                    val ext = project.extensions.getByType(org.example.k2j.gradle.K2jExtension::class.java)
                    doLast {
                        ...
                        println("vendoredJar=" + org.example.k2j.gradle.K2jExtension.VENDORED_DECOMPILER_JAR)
                        println("vendoredSha=" + org.example.k2j.gradle.K2jExtension.VENDORED_DECOMPILER_JAR_SHA256)
